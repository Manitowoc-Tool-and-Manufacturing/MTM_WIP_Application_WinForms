# Legacy MySQL Database Schema: Stored Procedures

This document outlines the stored procedures in the legacy `mtm_wip_application` database.
...
- `assign_BatchNumber_Step0` - `Step4`
