...
3. Update `.csproj` to version 6.3.3.0
...
7. Report: "✅ Updated to version 6.3.3.0 - Release notes updated, databases updated"
...
- Version format: `Major.Minor.Patch.Build` (e.g., 6.3.3.0)
