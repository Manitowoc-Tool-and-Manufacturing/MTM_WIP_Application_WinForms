/*!50003 DROP PROCEDURE IF EXISTS `sp_error_reports_GetUserList` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `sp_error_reports_GetUserList`(OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
