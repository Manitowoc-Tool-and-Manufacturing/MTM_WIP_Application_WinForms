/*!50003 DROP PROCEDURE IF EXISTS `sp_error_reports_GetByID` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `sp_error_reports_GetByID`(IN `p_ReportID` INT, OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
