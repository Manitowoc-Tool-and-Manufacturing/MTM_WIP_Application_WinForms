...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `sp_error_reports_GetAll`(IN `p_DateFrom` DATETIME, IN `p_DateTo` DATETIME, IN `p_UserName` VARCHAR(100), IN `p_MachineName` VARCHAR(200), IN `p_StatusFilter` VARCHAR(20), IN `p_SearchText` VARCHAR(255), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
