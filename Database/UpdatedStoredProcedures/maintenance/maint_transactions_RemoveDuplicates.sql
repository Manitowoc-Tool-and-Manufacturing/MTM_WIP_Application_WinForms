...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `maint_transactions_RemoveDuplicates`(IN `p_DuplicateType` VARCHAR(50), IN `p_CreateBackup` BOOLEAN, OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
