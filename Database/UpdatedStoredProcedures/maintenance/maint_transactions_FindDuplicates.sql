...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `maint_transactions_FindDuplicates`(IN `p_DuplicateType` VARCHAR(50), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
