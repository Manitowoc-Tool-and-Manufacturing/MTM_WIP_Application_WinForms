...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `log_error_Get_ByDateRange`(IN `p_StartDate` DATETIME, IN `p_EndDate` DATETIME, OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
