...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `sys_last_10_transactions_DeleteAll_ByUser`(IN `p_User` VARCHAR(100), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
