...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `inv_inventory_Transfer_Part`(IN `p_BatchNumber` VARCHAR(300), IN `p_PartID` VARCHAR(300), IN `p_Operation` VARCHAR(100), IN `p_NewLocation` VARCHAR(100), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
