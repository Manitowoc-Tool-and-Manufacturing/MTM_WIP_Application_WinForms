...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `inv_inventory_Get_ByPartIDandOperation`(IN `p_PartID` VARCHAR(300), IN `p_Operation` VARCHAR(300), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
