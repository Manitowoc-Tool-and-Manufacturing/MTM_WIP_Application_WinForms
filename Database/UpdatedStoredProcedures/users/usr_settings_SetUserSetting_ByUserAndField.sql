...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `usr_settings_SetUserSetting_ByUserAndField`(IN `p_User` VARCHAR(100), IN `p_Field` VARCHAR(100), IN `p_Value` VARCHAR(500), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
