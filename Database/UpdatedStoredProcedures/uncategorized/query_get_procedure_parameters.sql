/*!50003 DROP PROCEDURE IF EXISTS `query_get_procedure_parameters` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `query_get_procedure_parameters`(IN `p_ProcedureName` VARCHAR(255), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
