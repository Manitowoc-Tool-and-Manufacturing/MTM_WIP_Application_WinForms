/*!50003 DROP PROCEDURE IF EXISTS `query_check_procedure_exists` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `query_check_procedure_exists`(IN `p_ProcedureName` VARCHAR(255), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
