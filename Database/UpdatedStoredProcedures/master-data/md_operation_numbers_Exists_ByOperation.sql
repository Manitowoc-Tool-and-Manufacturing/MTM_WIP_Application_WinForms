...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `md_operation_numbers_Exists_ByOperation`(IN `p_Operation` VARCHAR(100), OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
