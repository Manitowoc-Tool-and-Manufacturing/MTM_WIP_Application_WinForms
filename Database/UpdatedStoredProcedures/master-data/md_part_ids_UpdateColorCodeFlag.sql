...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `md_part_ids_UpdateColorCodeFlag`(IN `p_PartID` VARCHAR(300), IN `p_RequiresColorCode` BOOLEAN, OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
