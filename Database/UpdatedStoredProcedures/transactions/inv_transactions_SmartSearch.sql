...
DELIMITER ;;
CREATE DEFINER=`root`@`172.16.1.104` PROCEDURE `inv_transactions_SmartSearch`(IN `p_WhereClause` TEXT, IN `p_Page` INT, IN `p_PageSize` INT, OUT `p_Status` INT, OUT `p_ErrorMsg` VARCHAR(500))
BEGIN
