...
namespace MTM_WIP_Application_Winforms.Controls.Shared
{
    ...
    public partial class SuggestionTextBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            SuggestionTextBox_TextBox.MinimumSize = new Size(120, 27);
            SuggestionTextBox_TextBox.Name = "SuggestionTextBox_TextBox";
            SuggestionTextBox_TextBox.Size = new Size(120, 27);
            ...
            SuggestionTextBox_Panel_Host.Padding = new Padding(0);
            SuggestionTextBox_Panel_Host.Size = new Size(120, 27);
            SuggestionTextBox_Panel_Host.TabIndex = 0;
            SuggestionTextBox_Panel_Host.TabStop = false;
            //
            // SuggestionTextBox
            //
