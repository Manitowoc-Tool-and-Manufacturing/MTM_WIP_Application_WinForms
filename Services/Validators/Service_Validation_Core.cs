...
/// </summary>
public static class Service_Validation_Core
{
    #region Fields
    ...
    /// </summary>
    static Service_Validation_Core()
    {
    ...
    private static void InitializeDefaultValidators()
    {
        ...
        RegisterValidator("PartNumber", new Validators.Service_PartNumberValidator());
        RegisterValidator("WorkOrder", new Validators.Service_WorkOrderValidator());
        RegisterValidator("LocationCode", new Validators.Service_LocationCodeValidator());
        
        // Register common numeric validators
        RegisterValidator("Quantity", new Validators.Service_NumericValidator(0, 999999, allowDecimals: false, fieldName: "Quantity"));
        RegisterValidator("Weight", new Validators.Service_NumericValidator(0, 99999.99m, allowDecimals: true, fieldName: "Weight"));
        RegisterValidator("Price", new Validators.Service_NumericValidator(0, 9999999.99m, allowDecimals: true, fieldName: "Price"));
    }
