...
/// </summary>
public class Service_NumericValidator : IValidator
{
    #region Fields
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Service_NumericValidator"/> class.
    /// </summary>
    ...
    public Service_NumericValidator(decimal min, decimal max, bool allowDecimals = false, string fieldName = "Value")
    {
        if (min > max)
        {
