# Interface Contract: IDao_DeveloperTools
...
`IDao_DeveloperTools` provides data access methods for the Developer Tools feature, interacting with the `log_error` table and other system tables.
