...
- **ErrorReport**: Represents a user-submitted error report
  - Attributes: ReportID, ReportDate, UserName, AppVersion, ErrorType, ErrorSummary, UserNotes, TechnicalDetails, CallStack, Status, ReviewedBy, ReviewedDate, DeveloperNotes
