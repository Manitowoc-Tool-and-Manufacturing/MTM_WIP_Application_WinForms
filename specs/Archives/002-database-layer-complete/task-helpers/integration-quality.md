...
| -------------------- | ------ | -------------- | --------------- | ------ |
| 1. Completeness      | 18     | ≥14 (78%)      | \_\_\_ / 18     | ⬜     |
| 2. Clarity           | 16     | ≥13 (81%)      | \_\_\_ / 16     | ⬜     |
| 3. Measurability     | 15     | ≥12 (80%)      | \_\_\_ / 15     | ⬜     |
| 4. Consistency       | 14     | ≥11 (79%)      | \_\_\_ / 14     | ⬜     |
| 5. Traceability      | 13     | ≥10 (77%)      | \_\_\_ / 13     | ⬜     |
| 6. Risk/Dependencies | 16     | ≥13 (81%)      | \_\_\_ / 16     | ⬜     |
| **TOTAL**            | **92** | **≥74 (80%)**  | **\_\_\_ / 92** | **⬜** |
...
- [ ] **Fallback scenario test**: Simulate INFORMATION*SCHEMA failure, verify convention fallback (p* prefix assumed)
- [ ] **Accuracy measurement**: 100% of procedures use p\_ prefix (or deviation documented)
