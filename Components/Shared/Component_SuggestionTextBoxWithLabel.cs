...
namespace MTM_WIP_Application_Winforms.Components.Shared
{
    ...
    public partial class Component_SuggestionTextBoxWithLabel : ThemedUserControl
    {
        #region Fields
        ...
        public Component_SuggestionTextBox TextBox => SuggestionTextBoxWithLabel_TextBox_Main;
        ...
        /// </summary>
        public Component_SuggestionTextBoxWithLabel()
        {
            InitializeComponent();
            WireUpEvents();
            TabStop = true;
