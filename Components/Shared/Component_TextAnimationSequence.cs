...
namespace MTM_WIP_Application_Winforms.Components.Shared
{
    ...
    public class Component_TextAnimationSequence : Component
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Component_TextAnimationSequence"/> class.
        /// </summary>
        public Component_TextAnimationSequence()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Component_TextAnimationSequence"/> class and adds it to a container.
        /// </summary>
        /// <param name="container">Designer container that should manage this component.</param>
        public Component_TextAnimationSequence(IContainer? container)
            : this()
        {
            container?.Add(this);
        }
